...
6. 다시 Tampermonkey를 클릭하면 아래와 같이 추가한 스크립트가 나타납니다. 이걸 on 상태로 만들어줍니다.
<img 너비="16" 높이="16" alt="c" src="https://github.com/user-attachments/assets/b2727c88-52d4-4a89-8f04-461035a4d526 " />
7. 스크립트가 적용되었다면 Roll20 채팅방에 들어갔을 때 우측 하단 전송 버튼 옆에 글자 크기 조절 버튼이 나타납니다.
